...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.discord.voice.lowLatency": "Discord Voice Low-Latency",
  "channels.discord.voice.lowLatency.enabled": "Discord Voice Low-Latency Enabled",
  "channels.discord.voice.lowLatency.llmChunking": "Discord Voice Low-Latency LLM Chunking",
  "channels.discord.voice.lowLatency.ttsStream": "Discord Voice Low-Latency TTS Stream",
  "channels.discord.voice.lowLatency.maxBufferedMs": "Discord Voice Low-Latency Max Buffered (ms)",
  "channels.discord.voice.lowLatency.chunkMaxChars": "Discord Voice Low-Latency Chunk Max Chars",
  "channels.discord.voice.lowLatency.idleFlushMs": "Discord Voice Low-Latency Idle Flush (ms)",
  "channels.discord.voice.lowLatency.fallbackBuffered":
    "Discord Voice Low-Latency Fallback Buffered",
